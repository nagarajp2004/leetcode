...
<strong>Explanation: </strong>The decreasing or increasing part cannot be empty</span><span style="font-size: 18px;"><br></span><span style="font-size: 18px;"><br></span><span style="font-size: 18px;"><strong>Input: </strong>n = 3, nums[] = [10, 10, 10]
<strong>Output: </strong>0
